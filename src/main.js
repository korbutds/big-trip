...
renderElement(tripEventsSection, tripBoard.getElement(), RenderPosition.AFTERBEGIN);
renderElement(tripEventsSection, tripBoard.getElement(), RenderPosition.BEFOREBEGIN);
renderElement(tripEventsSection, tripBoard.getElement(), RenderPosition.BEFOREBEGIN);

for (let i = 1; i < POINT_COUNT - 1; i++) {
  renderElement(tripBoard.getElement(), new TripPoint(points[i]).getElement(), RenderPosition.BEFOREBEGIN);
}
